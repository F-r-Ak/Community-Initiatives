...
import { DevelopmentServiceService } from '../../../../../shared';
...
@Component({
    ...
    styleUrl: './development-services.component.scss'
})
export class DevelopmentServicesComponent extends BaseListComponent {
    tableOptions!: TableOptions;
    authHelper = inject(AuthHelper);
    service = inject(DevelopmentServiceService);
    get rolesEnum() {
        return RoleCodes;
    }
    ...
    initializeTableOptions() {
        this.tableOptions = {
            inputUrl: {
                getAll: 'v1/developmentservice/getpaged',
                getAllMethod: 'POST',
                delete: 'v1/developmentservice/delete'
            },
