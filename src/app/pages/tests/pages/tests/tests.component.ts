...
import { TestsService } from '../../../../shared';
import { AddEditTestComponent } from '../../components/add-edit-test/add-edit-test.component';
...
export class TestsComponent extends BaseListComponent {
    tableOptions!: TableOptions;
    service = inject(TestsService);
    ...
    openAdd() {
        this.openDialog(AddEditTestComponent, 'اضافة مركز', {
            pageType: 'add'
        });
    }

    openEdit(rowData: any) {
        this.openDialog(AddEditTestComponent, 'تعديل  مركز', {
            pageType: 'edit',
            row: { rowData }
        });
    }
